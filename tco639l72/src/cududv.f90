...
SUBROUTINE cududv(nxj,klon,klev,klevp1,ktopm2,ktype,kcbot,paphp1, &
&      ldcum,puen,pven,pvom,pvol,puu,pud,pvu,pvd,pmfu,pmfd,jin)
...
!  INTEGER, INTENT (IN) :: klon, klev, klevp1, ktopm2
  INTEGER, INTENT (IN) :: klon, nxj, klev, klevp1, ktopm2
...
! jwhwu 201209 for CWB, output tendency is for cumulus only
