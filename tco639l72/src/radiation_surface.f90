...
!===> ...  begin here
!
      if ( me == 0 .and. myrank == 0) print *, vtagsfc   ! print out version tag
...
!cmy
        if ( .not. allocated(jdxems) ) then
          allocate ( jdxems(imxems,jmxems)    )
        endif
!cmy
...
!cmy      read (niradsf,14) idxems
          read (niradsf,14) jdxems
  14      format(80i1)
