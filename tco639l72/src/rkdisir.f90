...
! *********************************************************************
!
! hk1~hk12 : the interval in the g (cumulative probability) space
!            from 0 to one for a given band (1~12) in ir region
!
! c1h2o : the coefficient to calculate the H2O absorption
!         coefficient in units of (cm-atm)**-1 at there temperatures,
!         nineteen pressures, and two cumulative probabilities.
!         The spectral region is from 2200 to 1900 cm**-1. (ir)
! c2h20 : as c1h2o, but  3 g-values and from 1900 to 1700 cm**-1. (ir)
! c3h2o : as c1h2o, but  4 g-values and from 1700 to 1400 cm**-1. (ir)
! c4h2o: as c1h20, but  4 g-values and from 1400 to 1250 cm**-1. (ir)
! c4ch4: the same spectrum region as c4h2o, but for ch4 absorption
!         coefficients at 1 g-value. (ir)
! c4n2o: the same spectrum region as c4h2o, but for n2o absorption
!         coefficients at 1 g-value. (ir)
! c5h2o: as c1h2o, but  3 g-values and from 1250 to 1100 cm**-1. (ir)
! c5ch4: as c4ch4, but from 1250 to 1100 cm**-1. (ir)
! c5n2o: as c4n2o, but from 1250 to 1100 cm**-1. (ir)
! c6o3 : as c1h2o, but for o3 absorption coefficients with 2 g-values
!         and from 1100 to  980 cm**-1. (ir)
! c6h2o: as c1h2o, but  1 g-value  and from 1100 to  980 cm**-1.
! c7h2o: as c1h2o, but  2 g-values and from 980 to 800 cm**-1. (ir)
! c8hca, c8hcb : the coefficients to calculate the H2O and CO2
!         overlapping absorption coefficients in units of (cm-
!         atm)**-1 at three temperature, nineteen pressures, and ten
!         cumulative probabilities. The spectral region is from 800
!         to 670 cm**-1. (ir)
! c9hca, c9hcb : as c8hca, c8hcb, but 12 g-values and from 670 to
!         540 cm**-1. (ir)
! c10h2o: as c1h2o, but  7 g-values and from 540 to 400 cm**-1. (ir)
! c11h2o: as c1h20, but  7 g-values and from 400 to 280 cm**-1. (ir)
! c12h2o: as c1h20, but  8 g-values and from 280 to 0 cm**-1. (ir)
!
!*************************************************************************
!
      common /ir1/ hk1(2), c1h2o(3,19,2)
      common /ir2/ hk2(3), c2h2o(3,19,3)
      common /ir3/ hk3(4), c3h2o(3,19,4)
      common /ir4/ hk4(4),c4h2o(3,19,4),c4ch4(3,19),c4n2o(3,19)
      common /ir5/ hk5(3),c5h2o(3,19,3),c5ch4(3,19),c5n2o(3,19)
      common /ir6/ hk6(5),c6o3(3,19,5),c6h2o(3,19)
      common /ir7/ hk7(2), c7h2o(3,19,2)
      common /ir8/ hk8(10), c8hca(3,19,10), c8hcb(3,19,10)
      common /ir9/ hk9(12), c9hca(3,19,12), c9hcb(3,19,12)
      common /ir10/ hk10(7), c10h2o(3,19,7)
      common /ir11/ hk11(7), c11h2o(3,19,7)
      common /ir12/ hk12(8), c12h2o(3,19,8)
!
      data hk1 / 0.7, 0.3 /
      data hk2 / 0.2, 0.7, 0.1 /
      data hk3 / 0.22, 0.51, 0.22, 0.05 /
      data hk4 / 0.28, 0.42, 0.25, 0.05 /
      data hk5 / 0.80, 0.15, 0.05 /
      data hk6 / 0.45, 0.30, 0.2, 0.04, 0.01 /
      data hk7 / 0.95, 0.05 /
      data hk8 / .3,.3,.2,.12,.06,.012,.004,.0025,.0011,.0004 /
      data hk9 /.24,.36,.18,.1,.05,.02,.016,.012,.01,.006,.0039,.0021/
      data hk10 / .12, .24, .24, .20, .12, .06, .02 /
      data hk11 / .12, .26, .22, .20, .10, .085, .015 /
      data hk12 / .07, .1, .2, .25, .2, .1, .03, .02 /
!
        data ( ( ( c1h2o(k,j,i), i = 1, 2 ), j = 1, 19 ), k = 1, 3 ) /  &
	...
	data ( ( ( c2h2o(k,j,i), i = 1, 3 ), j = 1, 19 ), k = 1, 3 ) /  &
	...
	data ( ( ( c3h2o(k,j,i), i = 1, 4 ), j = 1, 19 ), k = 1, 3 ) /  &
	...
	data ( ( ( c4h2o(k,j,i), i = 1, 4 ), j = 1, 19 ), k = 1, 3 ) /  &
	...
	data ( ( ( c5h2o(k,j,i), i = 1, 3 ), j = 1, 19 ), k = 1, 3 ) /  &
	...
	data ( ( ( c6o3(k,j,i), i = 1, 5 ), j = 1, 19 ), k = 1, 3 ) /   &
	...
	data ( ( ( c7h2o(k,j,i), i = 1, 2 ), j = 1, 19 ), k = 1, 3 ) /  &
	...
	data ( ( c8hca(1,j,i), i = 1, 10 ), j = 1, 19 ) /               &
      ...
      -.9695E+01,-.5977E+01,-.3427E+01,-.1596E+01,-.1979E+00, .9458E+00,&
       .1363E+01, .1545E+01, .1743E+01, .1832E+01/
        data ( ( c8hca(2,j,i), i = 1, 10 ), j = 1, 19 ) /               &
                                                   .3628E-01, .2728E-01,&
      ...
      -.7633E-04,-.7300E-04/
        data ( ( c8hca(3,j,i), i = 1, 10 ), j = 1, 19 ) /               &
	...
	data ( ( c8hcb(1,j,i), i = 1, 10 ), j = 1, 19 ) /               &
      ...
      -.4587E+02,-.4587E+02,-.4587E+02,-.4587E+02/
        data ( ( c8hcb(2,j,i), i = 1, 10 ), j = 1, 19 ) /               &
                                                   .2944E-01, .2723E-01,&
       ...
       .4083E-01, .4580E+00/
        data ( ( c8hcb(3,j,i), i = 1, 10 ), j = 1, 19 ) /               &
	...
	data ( ( ( c9hca(k,j,i), i = 1, 12 ), j = 1, 19 ), k = 1, 2 ) / &
	...
	data ( ( ( c9hca(k,j,i), i = 1, 12 ), j = 1, 19 ), k = 3, 3 ) / &
	...
	data ( ( ( c9hcb(k,j,i), i = 1, 12 ), j = 1, 19 ), k = 1, 2 ) / &
	...
	data ( ( ( c9hcb(k,j,i), i = 1, 12 ), j = 1, 19 ), k = 3, 3 ) / &
	...
	data ( ( ( c10h2o(k,j,i), i = 1, 7 ), j = 1, 19 ), k = 1, 3 ) / &
	...
	data ( ( ( c11h2o(k,j,i), i = 1, 7 ), j = 1, 19 ), k = 1, 3 ) / &
	...
	data ( ( ( c12h2o(k,j,i), i = 1, 8 ), j = 1, 19 ), k = 1, 3 ) / &
