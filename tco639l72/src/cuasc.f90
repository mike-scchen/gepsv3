...
SUBROUTINE cuasc(nxj,klon,klev,klevp1,klevm1,ptenh,pqenh,pxenh,puen,                  &
...
!  INTEGER, INTENT (IN) :: klon, klev, klevm1, klevp1
  INTEGER, INTENT (IN) :: klon, nxj, klev, klevm1, klevp1
...
!      CALL cubasmc(klon,klev,ik,pten,pqen,pqsen,puen,pven, &
      CALL cubasmc(nxj,klon,klev,ik,pten,pqen,pqsen,puen,pven, &
...
!    CALL cuentr(klon,klev,klevp1,ik,ptenh,paphp1,papp1,klwmin,ldcum,       &
    CALL cuentr(nxj,klon,klev,klevp1,ik,ptenh,paphp1,papp1,klwmin,ldcum,       &
...
!    CALL cuadjtq(klon,klev,ik,zph,ptu,pqu,loflag,icall)
    CALL cuadjtq(nxj,klon,klev,ik,zph,ptu,pqu,loflag,icall)
...
!             zdnoprc = MERGE(1.E4,1.5E4,ldland(jl))  ! <--- Hier eine Ursache fuer 
