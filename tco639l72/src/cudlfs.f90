...
SUBROUTINE cudlfs(nxj,klon,klev,klevp1,ptenh,pqenh,puen,pven,&
...
!  INTEGER, INTENT (IN) :: klon, klev, klevp1
  INTEGER, INTENT (IN) :: klon, nxj, klev, klevp1
...
!    CALL cuadjtq(klon,klev,ik,zph,ztenwb,zqenwb,llo2,icall)
    CALL cuadjtq(nxj,klon,klev,ik,zph,ztenwb,zqenwb,llo2,icall)
