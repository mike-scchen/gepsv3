...
!GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD 
 module module_gocart_coupling_gpu
...
!
  public ::  & 
                ...
                mass2ccn_gpu, & ! convert GOCART aerosol mass into CCN #. 
                mass2icn_gpu, & ! convert GOCART aerosol mass into IN #.
         makelut_ccn_icn_gpu    ! make CCN look-up tables
! ##############################################################################
...
!CCN IN LUT parameter
 ...
 integer, parameter,public :: mxpts_s  = 46  ! LUT dimension for super saturation 
 real, parameter,public :: pts_s(mxpts_s) = & ! LUT super saturation vector [%]
 ...
 integer, parameter,public :: mxpts_t  = 12  ! LUT dimension for temperature
 real, parameter,public :: pts_t(mxpts_t) = & ! LUT temperature vector [K] for frozen hydrometeors
...
! real :: lut_in_025(1:tgmx) ! LUT for aerosol # per unit mass mixing ratio [#/cm3 per 1g/m3]
 real, public :: lut_ccn(1:mxpts_t,1:mxpts_s,1:nlut)  ! LUT for CCN # per unit mass mixing ratio
 real, public :: lut_in_025(1:nlut) ! LUT for aerosol # per unit mass mixing ratio [#/cm3 per 1g/m3]
...
!GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD 
 ...
 subroutine mass2ccn_gpu(t_air,s,aero,ccn_out, lut_ccn, pts_t, pts_s, mxpts_t, mxpts_s, nlut, lut_ccn_interp)
 !$acc routine seq
 !$acc routine(interp_gpu) seq
 implicit none
!------------------------------------------------------------------------
...
!------------------------------------------------------------------------
 integer, intent(in) :: mxpts_t, mxpts_s, nlut
...
! real,intent(in) :: aero(tgmx) !aerosol mass conc [g/m3]
 ...
 real, intent(in) :: lut_ccn(1:mxpts_t,1:mxpts_s,1:nlut) !acc routine
 integer :: im !looping
 real :: ccn   !accmulating CCN conc [#/cm3]
! real :: lut_ccn_interp(tgmx) ! interpolated LUT value 
 real, intent(inout) :: lut_ccn_interp(nlut) ! interpolated LUT value 
 real, intent(in) :: pts_t(mxpts_t), pts_s(mxpts_s)
...
!
 call interp_gpu( t_air, s, lut_ccn_interp , lut_ccn, pts_t, pts_s, mxpts_t, mxpts_s, nlut)
...
!
 ...
 end subroutine mass2ccn_gpu

!GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD 
!GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD 

 subroutine interp_gpu(t_air,s_rate,lut_ccn_interp, lut_ccn, pts_t, pts_s, mxpts_t, mxpts_s, nlut)
 !$acc routine seq
 implicit none
...
!             + ( lut_ccn(it,is+1,1:tgmx)*wgt1_t + lut_ccn(it+1,is+1,1:tgmx)*wgt2_t ) * wgt2_s
 ...
 end subroutine interp_gpu

!GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD 
!GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD 

 subroutine mass2icn_gpu(p_air,t_air,aero,icn_out, nlut, lut_in_025)!,ii,jj,kk)
 !$acc routine seq
...
! real,intent(in) :: aero(tgmx) !aerosol mass conc [g/m3]
 ...
 real, intent(in) :: lut_in_025(1:nlut)
...
! coefficient of empirical formulae in DeMott 2010
 ...
 if( maxval( lut_in_025 ) == 0.e0 ) stop 'MSG mass2icn_gpu: you have not initialize lut_in_025 yet. Stop program' 
...
!
 icn_estimate = icn_std * (p_air*t_std) / (p_std*t_air)  ! [#/std L] --> [#/L]
         ...
         if( ieee_is_nan( icn_estimate ) ) then
            !print*, 'NAN in mass2icn_gpu, icn_estimate = ', icn_estimate
            !print*, 'lut_in_025 =',lut_in_025
            !print*, 'icn_std, t_std, p_std, p_air, t_air =', icn_std, t_std, p_std, p_air, t_air
            !print*, 'aero = ', aero
            stop 'stop!!!!!'
         endif
         if( .NOT. ieee_is_finite( icn_estimate ) ) then
            !print*, 'INF in mass2icn_gpu, icn_estimate = ', icn_estimate
            !print*, 'icn_std, t_std, p_std, p_air, t_air =', icn_std, t_std, p_std, p_air, t_air
            !print*, 'aero = ', aero
            stop 'stop!!!!!'
         endif
...
! icn_out = min(1.e6, max(1.e2 ,  icn_estimate) )  ! [#/L]
 ...
 end subroutine mass2icn_gpu

!GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD 
!GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD 

 subroutine makelut_ccn_icn_gpu
 use rank
 implicit none
!------------------------------------------------------------------------
...
!------------------------------------------------------------------------
 ...
 if ( myrank .eq. 0 ) print *,' inside makelut_ccn_icn_gpu ' 

! if(master) print*,'MSG: makelut_ccn_icn_gpu: making LUT of CCN and IN'
...
!                       r_max%micm, rho%micm , n_ccn, frac_ccn, n_gccn, frac_gccn,lut_in_025(14),frac_025)
 ...
 !$acc enter data copyin(lut_in_025, lut_ccn)
 if ( myrank .eq. 0 )  print *,' done makelut_ccn_icn_gpu ' 

 end subroutine makelut_ccn_icn_gpu
...
!GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD GODDARD
 ...
 end module module_gocart_coupling_gpu
!#else
