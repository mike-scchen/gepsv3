...
SUBROUTINE cuini(nxj,klon,klev,klevp1,klevm1,pten,pqen,pqsen,pxen, &
&      puen,pven,&
pverv,pgeo,paphp1, &
...
!    CALL cuadjtq(klon,klev,ik,zph,ptenh,pqsenh,loflag,icall)
    CALL cuadjtq(nxj,klon,klev,ik,zph,ptenh,pqsenh,loflag,icall)
