...
!CWB2018 for gfs by CH Lee, using fftw-3.3.7
      ...
      if(mod(jump,2).eq.0) then  !jump is even 
         if(isign.eq.1) then     !FFTW_BACKWARD
            ...
            enddo
            enddo
            call dfftw_plan_many_dft_c2r(plan_c2r,1,n,m,pa,n,inc,nn,a,n,inc,jump,FFTW_ESTIMATE)
...
!     write(cid,'(i4.4)')myrank
!     wisdom_file="/users/xa09/fftw/wisdom.TL1151L60."//cid//char(0)
!     wisdom_file="/users/xa09/fftw/wisdom.TCo575L60."//cid//char(0)
...
!     real x(2*ldx,*),y(ldy,*),scale,table(44002),wrk,z
      real x(2*ldx,*),y(ldy,*),scale,table(n1),wrk(n2),z(1)
...
!     real x(ldx,*),y(2*ldy,*),scale,table(44002),wrk,z
      real x(ldx,*),y(2*ldy,*),scale,table(n1),wrk(n2),z(1)
