...
!...................................
!  ---  inputs: &
           ( imj,im, km, ps, u1, v1, t1, q1, soiltyp, vegtype, sigmaf,  &  
             sfcemis, dlwflx, dswsfc, snet, delt, tg3, cm, ch,          &  
             prsl1, prslki, zf, islimsk, ddvel, slopetyp,               & 
             shdmin, shdmax, snoalb, sfalb, flag_iter, flag_guess,      & 
             isot, ivegsrc,                                             &
...
!  ---  input:
      integer, intent(in) :: im, km, isot, ivegsrc, imj
...
!     real (kind=kind_phys), dimension(im), intent(inout) :: weasd,     & 
      real (kind=kind_phys), dimension(im) :: weasd,     & 
...
!     real (kind=kind_phys), dimension(im), intent(out) :: sncovr1,     & 
      real (kind=kind_phys), dimension(im)  :: sncovr1,     & 
