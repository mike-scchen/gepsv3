...
!===>  ...  begin here
!
      if ( me == 0 .and. myrank == 0) print *, vtagast    !print out version tag
...
!  ---  input:
      integer, intent(in) :: jdate(:), kyear, me, myrank
...
! 26            format(i4,f10.4)
     ...
     &                       iyr, solc1, solc0
                  ...
                  if(me == 0 .and. myrank == 0)print *,'  skip solar const data for yr',i
                  i = i - 1
                endif
              enddo   lab_dowhile3
