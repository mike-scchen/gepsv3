...
!===>  ...  begin here
!
      if ( me == 0 .and. myrank == 0) print *, vtagaer    ! print out version tag
...
!  --- ...  loop over 12 month global distribution
  ...
  12    format(a80/)
        ...
        if ( m /= imon ) then
          if ( me == 0 .and. myrank == 0) print *,'  *** skipped ',cline
          ...
          if ( me == 0  .and. myrank == 0 ) print *,'  --- reading ',cline
!cmy--------------------------------------------------------------------
!cmy tranfer j from N->S to S->N
!cmy--------------------------------------------------------------------
!cmy      do j = 1, jmxae !N->S
...
!  ---  inputs:
     &     ( prsi,prsl,prslk,tvly,rhlay,slmsk,tracer,xlon,xlat,         &
     &       imax,nlay,nlp1,lsswr,lslwr,me,myrank,                      &
!  ---  outputs:
     &       aerosw,aerolw                                              &
!    &       aerosw,aerolw,aerodp                                       &
     &     )
...
!  ---  inputs:
      integer, intent(in) :: imax, nlay, nlp1,me,myrank
