...
!                                                                      !
!   program history:                                                   !
!     nov 2012 - y-t hou     created to place many physics related     !
!              model control variables in a easy to access/adjust      !
!              place.  run time determined control variables are marked!
!              by save atribute and assigned by their default values.  !
!              while for those less changed control variables are given!
!              a parameter atribute.                                   !
!     may 2014 - h-m lin/y-t hou  changed lw and sw control flags for  !
!              cloud liquid/ice property schemes 'ilwliq, ilwice,      !
!              iswliq, iswice' from the fixed 'parameter' atribute to  !
!              adjustable 'save' atribute.                             !
!                                                                      !
!!!!!  ==========================================================  !!!!!
...
!==================================================================================
!  Section - 1 -
!     for main radiation modules
!     control flags with parameter atribute are pre-set as run-time non-adjuztable.
!     control flags with save atribute are run-time adjustable
!==================================================================================
...
! ............................................. !
      integer,parameter :: iswrate = 2  ! sw heating rate unit control flag
                                        ! =1:k/day; =2:k/second.
      integer, save     :: iswrgas = 1  ! sw rare gases effect control flag (ch4,n2o,o2,...)
                                        ! =0:no; =1:yes.
      integer, save     :: iswmode = 2  ! sw control flag for 2-stream transfer scheme
...
! ............................................. !
      integer,parameter :: ilwrate = 2  ! lw heating rate unit (1:k/day; 2:k/second)
                                        ! =1:k/day; =2:k/second.
      integer, save     :: ilwrgas = 1  ! lw rare gases effect control flag (ch4,n2o,o2,cfcs...)
                                        ! =0:no; =1:yes.
...
!  -1.3- control flag for lw aerosol property   !
      logical, save     :: lalw1bd =.false. ! =t: use 1 broad-band lw aeros properties
...
!cmy  integer, save :: ivflip  = 1      ! vertical profile indexing flag
      integer, save :: ivflip  = 0      ! vertical profile indexing flag
