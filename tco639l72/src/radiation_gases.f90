...
!  ---  locals:
      ...
      real (kind=kind_phys), dimension(imxco2,jmxco2,12) :: co2dat3
...
!===>  ...  begin here
!
      if ( me == 0 .and. myrank == 0) print *, vtaggas    ! print out version tag
...
!cmy--------------------------------------------------------------------
!cmy --- transfer j-index from N->S : 1-jmxco2 to S->N : 1-jmxco2
!cmy--------------------------------------------------------------------
              do imo = 1, 12
...
!check          print cform, co2dat
                ...
                do j = 1, jmxco2
                  do i = 1, imxco2
                    co2dat3(i,j,imo) = co2dat(i,j) * 1.0e-6
                  enddo
                enddo
               enddo
!cmy--------------------------------------------------------------------
              do imo = 1, 12
                do j = 1, jmxco2
                   jn = jmxco2-j+1
                  do i = 1, imxco2
                    co2vmr_sav(i,jn,imo) = co2dat3(i,j,imo)
                  enddo
                enddo
              enddo
!cmy--------------------------------------------------------------------
...
!check          print cform, co2dat
              ...
              do imo = 1, 12
                do j = 1, jmxco2
                   jn = jmxco2-j+1
                  do i = 1, imxco2
                    co2cyc_sav(i,jn,imo) = co2dat3(i,j,imo)
                  enddo
                enddo
              enddo
!cmy--------------------------------------------------------------------
...
!  ---  inputs:
     &     ( myrank, iyear, imon, iday, ihour, loz1st, ldoco2, me )
!  ---  outputs: ( none )
...
!  ---  inputs:
      integer, intent(in) :: iyear, imon, iday, ihour, me, myrank
...
!  ---  locals:
      ...
      integer    :: i, id, j, l, iyr, imo, iyr1, iyr2, jyr, idyr, jn
...
!cmy--------------------------------------------------------------------
            ...
            do imo = 1, 12
              do j = 1, jmxco2
                do i = 1, imxco2
                  co2dat3(i,j,imo) = co2ann(i,j)+co2cyc_sav(i,j,imo)
                enddo
              enddo
            enddo
...
!check        print cform, co2dat
              ...
              do j = 1, jmxco2
                do i = 1, imxco2
                  co2dat3(i,j,imo) = (co2dat(i,j) + rate) * 1.0e-6
                enddo
              enddo
            enddo
