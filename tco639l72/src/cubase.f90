...
SUBROUTINE cubase(nxj,klon,klev,klevp1,klevm1,ptenh,pqenh,pgeoh,paph, &
&      ptu,pqu,plu,puen,pven,puu,pvu,ldcum,kcbot,klab,jin)
...
&                         puu(klon,klev), pvu(klon,klev)
  ...
  !  Local scalars: 
  REAL(r8) :: zbuo, zz
  INTEGER :: icall, ik, ikb, is, jk, jl, jin
