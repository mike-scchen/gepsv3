...
! =======================================================================
module cld_eff_rad_v2
    
    use module_mp_gfdl_v2, only: rdgas, grav, pi, zvir, t_ice, ql0_max, &
...
subroutine cld_eff_rad                                       & 
      ( is, ie, ks, ke, lsm, p, delp, t, qw, qi, qr, qs, qg, &
        qa, qcw, qci, qcr, qcs, qcg, rew, rei, rer, res, reg, &
        cld, snowd, cnvw, cnvi, cnvc)
