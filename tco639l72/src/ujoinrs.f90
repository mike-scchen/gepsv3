...
!
      subroutine ujoin1rs(wss,s1,jtrun,jtmax,lev,mlistnum,ncld)
!
      implicit  none
      real      wss (lev,2,ncld,jtrun,jtmax)
      real      s1(lev*ncld,2,jtrun,jtmax)
...
!
      ...
      do 10 k = 1, lev
        kk=nk+k
        s1(kk,1,l,m) = wss(k,1,n,l,m)
        s1(kk,2,l,m) = wss(k,2,n,l,m)
  10  continue
