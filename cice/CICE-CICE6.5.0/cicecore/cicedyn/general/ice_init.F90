...
! author Elizabeth C. Hunke, LANL
      ...
      use ice_calendar, only: year_init, month_init, day_init, sec_init, &
                              ...
                              npt, dt, dt_cpl, ndtd, days_per_year, use_leap_years, &
...
!         file=__FILE__, line=__LINE__)
...
#endif
      dt_cpl = 3600.0_dbl_kind ! coupler time step, s, ycshao
      ...
      call broadcast_scalar(dt_cpl,               master_task)
