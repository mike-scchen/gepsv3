...
!        where most of the work is done.
      ...
      subroutine CICE_Initialize(mpicomm_cpl)

      integer (kind=int_kind), optional, intent(in) :: mpicomm_cpl
      character(len=*), parameter :: subname='(CICE_Initialize)'
   !--------------------------------------------------------------------
   ! model initialization
   !--------------------------------------------------------------------
   !ycshao, add mpicomm_cpl
      if(present(mpicomm_cpl)) then
        call cice_init(mpicomm_cpl)
      else
        call cice_init
      end if
...
!  Initialize CICE model.
      ...
      subroutine cice_init(mpicomm_cpl)
...
!jwhwu
      ...
      call init_communicate(mpicomm_cpl) ! initial setup for message passing
