module tai_timcom_datm
  use tai_timcom_const
  use tai_timcom_comm
  use tai_timcom_grid, only: data_panel
  use tai_timcom_general, only: atm_grid_num,  timer_panel
  implicit none
...
subroutine datm_init(grid_list)
  use tai_timcom_general, only: str_split, member, atm_grid_num
  implicit none
