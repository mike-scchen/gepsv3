...
subroutine ice_formation(nx, ny, nz, kb, odz, p0, t2, s2, qice, aqice, qflux)
  implicit none
...
!-----------------------------------------------------------------------
   ...
   !work1 = work1 + p0lf/grav + eps2 !may cause unstable at np
