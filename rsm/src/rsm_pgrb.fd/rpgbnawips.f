...
!                                                                       
!$$$                                                                    
      PARAMETER(LEVT=6,LEVZ=3,NROW=4,MYBIT=16,LEV100=5)
...
!       
!     IL2(KZZU:KZZU+KZZ-1)=ZZ(1:KZZ)
!     IL2(KZZV:KZZV+KZZ-1)=ZZ(1:KZZ)
!     IL2(KZZT:KZZT+KZZ-1)=ZZ(1:KZZ)
...
!                                                                       
 ...
 100  FORMAT('endvars')                                                 
     ...
     &                VAR133(255),SFC133(255),DSL133(255)               
      ...
      DATA NUMVARS,NUMSFCS,IPTVS,NUMS,NNS/4*0/                          
!                                                                       
