...
!cc for base field
      ...
      integer lsoil,nmtvr
#if defined(RMTN_STUB_ONLY) || defined(GTOPO30)
      real mtnres
#endif
#ifdef SRTM1ARC
      real mtnres
#endif
#if !defined(RMTN_STUB_ONLY) && !defined(GTOPO30) && !defined(SRTM1ARC)
      integer mtnres
#endif
...
#endif
#ifdef SRTM1ARC
      parameter(mtnres  = 1./60.)
      parameter(nmtvr   = 1)
#endif
#if !defined(RMTN_STUB_ONLY) && !defined(GTOPO30) && !defined(SRTM1ARC)
      parameter(mtnres  = %mtnres)
!c     parameter(nmtvr   = 1)
!c     parameter(nmtvr   = 6)
      parameter(nmtvr   = 10)
...
!c juns change, make rmtn smoother
