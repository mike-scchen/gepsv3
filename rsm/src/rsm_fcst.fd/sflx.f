...
!
      use rphyscons,   only : con_cp, con_rd, con_t0c, con_g, con_pi,    &
...
!yj:!  --- ...  bexp sfc-perts, mgehne
!yj:      if( bexpp < 0.) then
!yj:         bexp = bexp * max(1.+bexpp, 0.)
!yj:      endif
!yj:      if( bexpp >= 0.) then
!yj:         bexp = bexp * min(1.+bexpp, 2.)
!yj:      endif
!yj:!  --- ...  lai sfc-perts, mgehne
!yj:      xlai = xlai * (1.+xlaip)
!yj:      xlai = amax1(xlai, .75)
!yj:
