!cccj
#include <inp_define.h>
#include <inpint_defdim.h>
!ccc
!cc for base field
      ...
      integer lsoil,nmtvr
#if defined(GMTED2010) || defined(GTOPO30) || defined(SRTM1ARC)
      real mtnres
#else
      integer mtnres
#endif
...
!!
      ...
      parameter(lsoil   = 2)
#endif
#if defined(GMTED2010) || defined(GTOPO30)
      parameter(mtnres = 0.5)
      parameter(nmtvr  = 14)
#elif defined(SRTM1ARC)
      parameter(mtnres = 1.0 / 60.0)
      parameter(nmtvr  = 1)
#else
      parameter(mtnres = 4)
!     parameter(nmtvr  = 1)
...
!c regional model base field parameters
      parameter(bgf     = 1)   ! delx base equal to  bgf time delx
